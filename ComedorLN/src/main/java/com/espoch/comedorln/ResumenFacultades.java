    ...
    public List<ResumenFacultades> convertirLista(List<Object[]> dataList) {
        ...
        try {
            for (Object[] object : dataList) {
                ...
                String facultad = (String) object[1];
                Integer enero = (Integer) object[2];
                Integer febrero = (Integer) object[3];
                Integer marzo = (Integer) object[4];
                Integer abril = (Integer) object[5];
                Integer mayo = (Integer) object[6];
                Integer junio = (Integer) object[7];
                Integer julio = (Integer) object[8];
                Integer agosto = (Integer) object[9];
                Integer septiembre = (Integer) object[10];
                Integer octubre = (Integer) object[11];
                Integer noviembre = (Integer) object[12];
                Integer diciembre = (Integer) object[13];
                Date fecha = (Date) object[14];
