...
/**
 * Jersey REST client generated for REST resource:OperativosFacadeREST
 * [com.espoch.comedorln.operativos]<br>
 * USAGE:
 * <pre>
 *        OperativosWS client = new OperativosWS();
...
public class OperativosWS {
    ...
    public OperativosWS() {
        ...
        webTarget = client.target(BASE_URI).path("com.espoch.comedorln.operativos");
    }
