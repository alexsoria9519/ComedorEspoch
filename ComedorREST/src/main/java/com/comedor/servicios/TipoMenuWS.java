...
/**
 * Jersey REST client generated for REST resource:TipomenuFacadeREST
 * [com.espoch.comedorln.tipomenu]<br>
 * USAGE:
 * <pre>
 *        TipoMenuWS client = new TipoMenuWS();
...
public class TipoMenuWS {
    ...
    public TipoMenuWS() {
        ...
        webTarget = client.target(BASE_URI).path("com.espoch.comedorln.tipomenu");
    }
