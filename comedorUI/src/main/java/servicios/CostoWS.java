...
public class CostoWS {
    ...
    public CostoWS() {
        ...
        webTarget = client.target(BASE_URI).path("com.comedorln.costo");
    }
    ...
    public void editEstado(Object requestEntity, String id) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updateestado/{0}", new Object[]{id})).request(javax.ws.rs.core.MediaType.APPLICATION_JSON).put(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }
