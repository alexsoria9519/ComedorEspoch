<%-- 
    ...
    Created on : 16/05/2019, 15:07:37
    Author     : corebitsas
--%>
...
<html>
    ...
    <body class="sidebar-fixed topnav-fixed dashboard">
                        ...
                        <nav class="main-nav">
                            <ul class="main-menu">
                                ...
                                <li style='cursor: pointer' title="TipoUsuario">
                                    <a onclick="" href="tipoUsuario.jsp">
        ...
        <div id="main-content-wrapper" class="content-wrapper">
            ...
            <div class="row"> 
                <div class="main-header col-md-6">
                    <h2><a href="tipoUsuario.jsp">Tipos de Usuarios</a></h2>
                ...
                <div id="contenidoInferior" class="main-content">
                    ...
                    <div class="row titulo" style="margin-bottom: 50px;">
                        ...
                        <div class="col-md-6"  style="padding-left: 18%;">
                            <h5> Listado de Tipos de Usuarios </h5>
                        </div>
        ...
        <script src="validacionTipoUsuario.js"></script>
