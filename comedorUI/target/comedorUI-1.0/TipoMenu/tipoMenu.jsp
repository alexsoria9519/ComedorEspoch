<%-- 
    Document   : tipoMenu
    Created on : 16/05/2019, 13:12:53
    Author     : corebitsas
--%>
...
<html>
    ...
    <body class="sidebar-fixed topnav-fixed dashboard">
        ...
        <div id="main-content-wrapper" class="content-wrapper">
            ...
            <div class="row"> 
                <div class="main-header col-md-6">
                    <h2><a href="tipoMenu.jsp">Tipos de Menu</a></h2>
                    <em id="nivel2"> Listado de Tipos de Usuarios </em>
                </div>
                <div class="col-md-6">
            ...
            <div id='contenidoDinamico' class="content" style=" margin-bottom:  25  px;">
                ...
                <div id="contenidoInferior" class="main-content">
                    ...
                    <div class="row titulo" style="margin-bottom: 50px;">


                        <div class="col-md-6"  style="padding-left: 18%;">
                            <h5> Listado de Tipos de Menus </h5>
                        </div>
                        <div class="col-md-6" id="numeroRegistros">
                            1 Registros
                        </div>
                    </div>    
        ...
        <script src="validacionTipoMenu.js"></script>
        <script src="tipoMenu.js"></script>
    </body>
