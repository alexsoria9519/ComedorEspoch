<%-- 
    ...
    Author     : Alex
--%>
<%@page import="com.comedorui.UsuariosUI"%>
        ...
        <div id="main-content-wrapper" class="content-wrapper">
            ...
            <div class="row" id="ruta"> 
                <div class="main-header col-md-6" >
                    <h2><a href="venta.jsp">Usuarios</a></h2>
                    <em id="nivel2"> Administración de usuarios </em> 
                    ...
                    <div class="card" style="margin-left: auto;margin-right: auto;width: 50%">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cedula" aria-describedby="emailHelp" placeholder="Cédula">
                            ...
                            <div class="form-group">
                                <button type="submit" onclick="registrarUsuario()" class="btn btn-primary">Registrar</button>
                            </div>
                        </div>
                    </div>
                </div>
